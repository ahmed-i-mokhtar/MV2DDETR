...
class CarlaDataset(VisionDataset):
    def __init__(self, root):
        ...
        self.__name__ = 'CarlaDataset'
        self.img_shape = [640, 640] # H,W; N_row,N_col
        self.num_cam, self.num_frame = 4, 592
        # unit in meters
...
def test():
    ...
    dataset = CarlaDataset(os.path.expanduser('~/Data/CarlaDataset'), )
